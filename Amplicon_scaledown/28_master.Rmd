...
```{r}
dat_types_ra_filtered <- filter_otus(dat_types_sub8000_ra, 0.1)
...
```
```{r}
plotDiffRelabund(metadata_otu_combined_summarized_trip_wide_protocol, "Organic")

plotDiffRelabund(metadata_otu_combined_summarized_trip_wide_protocol, "Sand")

plotDiffRelabund(metadata_otu_combined_summarized_trip_wide_protocol, "Sand-Clay")

plotDiffRelabund(metadata_otu_combined_summarized_trip_wide_protocol, "Clay")

ggsave(here("Amplicon_scaledown", "figures", "diffrelabund_clay.png"), device = "png", width = 8, height = 7)
```
