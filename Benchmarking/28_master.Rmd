...
phylum_vector <- grep("_{2}", colnames(ampdata$metadata), value = TRUE)
```


```{r}
ordinate_soil_data <- function(soil) {
  generateAmpliconOrdinationData(ampdata, soil, ord_type = "PCA", envvector = phylum_vector)
}
```
