...
names <- tibble(
  ...
  new_names = c("Soil type", "Properties", "Kit", "DNA ext conc. [ng/µL]", "260/280", "260/230", "Libraries", "Library conc. [ng/µL]", "Shannon Diversity", "Bray-Curtis Variation") # "Site name", "Longitude Latitude", "Environment",
)
