...
writexl::write_xlsx(final_table, here("Scaledown", "figures", "S3_Table.xlsx"))
```
...
ggsave(here("Scaledown", "figures", "pre_S3Fig.png"), plot = plot.ord, device = "png", height = 12, width = 19)
...
ggsave(here("Scaledown", "figures", "pre_S5Fig.tif.png"), plot = p.diff, device = "png", height = 12, width = 19)
...
ggsave(here("Scaledown", "figures", "pre_Fig3.png"), plot = gg_arranged, device = "png", height = 12, width = 20)
