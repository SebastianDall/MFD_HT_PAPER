...
#  articletheme +
#  scale_fill_gradient(low = "white", high = colors[3], trans = "log10", breaks = c(10, 1, 0.1, 0.01), na.value = "white") +
#  scale_x_discrete(limits = c("Small-scale", "Full-scale"), labels = c("2 x 5 µL", "2 x 25 µL")) +
...
#plot.heatmap_ASV <- dat.types.sub3000.amp %>%
...
#  scale_x_discrete(limits = c("Small-scale", "Full-scale"), labels = c("2 x 5 µL", "2 x 25 µL")) +
#  #scale_y_discrete(labels = rev(c(genus.text.renamed[c(2:26)]))) +
#  labs(x = "", y = "", title = "Heatmap aggregated at the ASV level", tag = "A") +
#  articletheme +
#  guides(fill = guide_colorbar(title.position = "top"))
